        ...
        <form action="/products/{{$product->id}}/update" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    style="resize: none; height: 150px;" placeholder="Enter Description">{{old('description',$product->description)}}</textarea>
            ...
            <div class="mb-3 text-center">
                <button type="submit" class="btn btn-dark me-2">Update Product</button>
